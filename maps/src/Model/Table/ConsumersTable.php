 ...
 * @method \App\Model\Entity\Consumer|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 ...
 * @method \App\Model\Entity\Consumer findOrCreate($search, callable $callback = null)
 */
